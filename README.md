...
- The main display now uses a high-fidelity retro digital time readout with scanlines and subtle flicker.
- Progress time readouts now keep the digital font styling without the glow for clearer readability.
